...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/0AwZN54pLu)
...
```sh
npx nx serve apri-code-assignment
```

To create a production bundle:

```sh
npx nx build apri-code-assignment
```

To see all available targets to run for a project, run:

```sh
npx nx show project apri-code-assignment
```
